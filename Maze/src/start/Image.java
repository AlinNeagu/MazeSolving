...
public class Image {
	...
	// citeste imaginea cu labirintul
	...
	// verifica daca vre un pixel este nod
		public boolean checkIfItIsNode(int x, int y) {
			...
			if ((color.alpha == 255) && (color.red == 255) && (color.green == 255) && (color.blue == 255)) {
				...
				//daca nodul e pe prima sau ultima linie/coloana atunci e nod de start sau finish.
				...
				// Dupa ce gasim un pixeil alb verificam daca si de sub el e alb
				if ((color.alpha == 255) && (color.red == 255) && (color.green == 255) && (color.blue == 255)) {
					down = 1;
				}
		...
		public void changeNodeColor(List<Node> nodes) {
			...
			// write image
			try {
				f = new File("C:\\Users\\Soul.Soul-PC\\Desktop\\Output.png");
